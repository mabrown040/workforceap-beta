...
export default async function LearningPage() {
  ...
  const programMeta = enrolledProgram
  ...
  const totalStepsAllPathways = PATHWAYS.reduce(
    (sum, p) => sum + p.steps.length,
    0,
  );
  const completedAll = allProgress.filter(
    (r) => r.status === "completed",
  ).length;
  const overallPct =
    totalStepsAllPathways > 0
      ? Math.round((completedAll / totalStepsAllPathways) * 100)
      : 0;
      ...
      >
        <div className="md:wa-hidden">
          ...
          <div style={{ padding: "1.5rem 1.5rem 0", marginBottom: "1.5rem" }}>
            <p
              className="wa-text-[11px] wa-font-medium wa-tracking-[0.1em] wa-uppercase wa-text-[var(--color-accent)]"
              style={{ display: "block", marginBottom: "0.5rem" }}
            >
              Your Learning
            </p>
            <h2 className="wa-text-3xl wa-font-bold wa-tracking-tight wa-text-[var(--color-on-surface)] wa-leading-tight">
              The Learning Hub
            </h2>
          </div>
          ...
          <section
            className="wa-bg-[var(--surface-container-low)]"
            style={{
              ...
              overflow: "hidden",
              border:
                "1px solid color-mix(in srgb, var(--outline-variant) 35%, transparent)",
            }}
          >
            <div
              style={{
            ...
            >
              <div style={{ zIndex: 10, width: "60%" }}>
                <h3
                  className="wa-text-lg wa-font-bold wa-leading-tight wa-text-[var(--color-on-surface)]"
                ...
                <p className="wa-text-sm wa-text-[var(--color-on-surface-variant)] wa-font-medium">
                  ...
                  {ACTIVE_PATHWAY.steps.length} modules
                </p>
              </div>
              {/* Progress orb */}
              <div
              ...
              >
                ...
                >
                  ...
                  <circle
                    ...
                    strokeDasharray="201"
                    strokeDashoffset={
                      201 - (201 * Math.min(100, overallPct)) / 100
                    }
                    strokeLinecap="round"
                  />
                </svg>
                <span
                  className="wa-text-base wa-font-bold wa-text-[var(--color-gold)]"
            ...
            <div
              style={{
                ...
                overflow: "hidden",
                background:
                  "color-mix(in srgb, var(--outline-variant) 45%, transparent)",
              }}
            >
              <div
                className="wa-bg-[var(--color-accent)]"
                style={{
        ...
        <div className="md:wa-hidden">
          ...
          <section style={{ margin: "0 1.5rem 1.5rem" }}>
            <div
              className="wa-bg-gradient-to-br from-[var(--color-accent-dark)] to-[var(--color-accent)] wa-text-white"
            ...
            >
              ...
              >
                <span
                  className="bg-white/20 wa-text-[10px] wa-font-bold wa-tracking-wider wa-uppercase"
                  style={{
                ...
                <span
                  className="material-symbols-outlined wa-text-sm"
                  style={{ "--ms-fill": 1 }}
                >
                  timer
                </span>
                <span className="wa-text-xs wa-font-medium">
                  ~{ACTIVE_PATHWAY.estimatedWeeks} weeks
                </span>
              </div>
              <h4
                className="wa-text-xl wa-font-bold wa-leading-snug"
                style={{ marginBottom: "1.25rem" }}
              >
                {ACTIVE_PATHWAY.title}
              </h4>
              <p
                className="text-white/80 wa-text-sm"
          ...
          <section style={{ margin: "0 1.5rem 1.5rem" }}>
            <h5
              className="wa-text-xs wa-font-bold wa-uppercase wa-tracking-widest wa-text-[var(--color-on-surface-variant)]"
              style={{ marginBottom: "1rem" }}
            >
              Pathway steps
            </h5>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {isCompleted
                          ...
                          : isLocked
                            ? "lock"
                            : (MODULE_ICONS[ACTIVE_PATHWAY.category] ??
                              "school")}
                      </span>
                    </div>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p className="wa-text-sm wa-font-semibold wa-text-[var(--color-on-surface)] wa-truncate">
                        {m.label}
                      </p>
                    </div>
                  </div>
              ...
              >
                {pathwayMilestones
                  ...
                  .map((m) => (
                    <div
                      key={m.stepIndex}
                      className="wa-bg-[var(--surface-container)] wa-border-l-4 wa-border-[var(--color-gold)]"
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: "1rem",
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <p
                          className="wa-text-[10px] wa-font-bold wa-uppercase wa-tracking-tight wa-text-[var(--color-gold)]"
        ...
        <div className="wa-hidden md:wa-block">
          ...
          <section style={{ marginBottom: "var(--space-8)" }}>
            ...
            >
              Track and mark each step as you complete it. Progress saves to
              your profile.
            </p>
