import '@/css/marketing-v3-privacy.css';
...
export default async function PrivacyPage() {
  ...
  return (
    <div className="wa-v3">
      {/* ===== PAGE HERO: crimson→plum gradient ===== */}
      <header className="wa-phero">
        <div className="wa-wrap">
          <div className="wa-inner">
            <span className="wa-ribbon">501(c)(3) nonprofit · built in Austin</span>
            <h1>{t('heading')}</h1>
            <p className="wa-sub">
      ...
      <section className="wa-content">
        <div className="wa-wrap">
          <div className="wa-doc">
            {locale !== 'en' && (
              <div role="note" className="wa-notice">
                {t('englishOnlyBanner')}{' '}
                ...
                <table aria-label="Sub-processors that process WorkforceAP member data">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th scope="col">Why</th>
                      <th scope="col">DPA / privacy link</th>
                    </tr>
                  </thead>
                  <tbody>
                    {SUB_PROCESSORS.map((sp) => (
                      <tr key={sp.vendor}>
                        <th scope="row">{sp.vendor}</th>
                        <td>{sp.data}</td>
                        <td>{sp.purpose}</td>
                        <td>
