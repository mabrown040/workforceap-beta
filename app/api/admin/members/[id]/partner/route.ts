  ...
  try {
    ...
    try {
      if (!partnerId) {
        ...
        void auditLog({ actorUserId: user.id, action: 'admin_member_partner_assign', targetType: 'user', targetId: memberId, metadata: { partnerId: null } }).catch(() => {});
      ...
      void auditLog({ actorUserId: user.id, action: 'admin_member_partner_assign', targetType: 'user', targetId: memberId, metadata: { partnerId } }).catch(() => {});
      return NextResponse.json({ ok: true });
    } catch (e) {
