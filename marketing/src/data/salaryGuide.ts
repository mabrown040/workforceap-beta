...
export const salaryGuideRows: SalaryGuideRow[] = [
  {
    ...
    program: "AWS Cloud Technology Professional Certificate (AWS)",
    duration: "160 hours • Hybrid, Self-Paced",
    salary: "$95K–$145K",
    level: "High",
    ramp: "Steeper",
    color: "#4a9b4f",
  ...
  },
  {
    ...
    duration: "160 hours • Online, Self-Paced",
    salary: "$88K–$130K",
    level: "High",
    ramp: "Steeper",
    color: "#4a9b4f",
  ...
  },
  {
    ...
    program: "Networking and Cybersecurity Professional Certificate (Net+, Sec+)",
    duration: "160 hours • Hybrid, Self-Paced",
    salary: "$75K–$112K",
    level: "Mid-High",
    ramp: "Steeper",
  ...
  },
  {
    ...
    program: "CompTIA Sec+ Professional Certificate (CompTIA Sec+)",
    duration: "3-5 months",
    salary: "$72K–$108K",
    level: "Mid-High",
    ramp: "Steeper",
  ...
  },
  {
    ...
    program: "CompTIA Net+ Professional Certificate (CompTIA Net+)",
    duration: "3-5 months",
    salary: "$60K–$88K",
    level: "Mid",
    ramp: "Moderate",
  ...
  },
  {
    ...
    program: "Digital Marketing & E-Commerce Professional Certificate (Google)",
    duration: "160 hours • Hybrid, Self-Paced",
    salary: "$62K–$78K",
    level: "Mid",
    ramp: "Moderate",
  ...
  },
  {
    ...
    program: "CompTIA A+ Professional Certificate (CompTIA A+)",
    duration: "160 hours • Hybrid, Self-Paced",
    salary: "$55K–$78K",
    level: "Mid",
    ramp: "Moderate",
...
export const salaryGuideSummaryStats: SalaryGuideSummaryStats = {
  ...
  highestProgram: "AWS Cloud Technology Professional Certificate (AWS)",
