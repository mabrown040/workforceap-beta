...
describe('employer applications PageHeader contract', () => {
  it('list page mounts one PageHeader outside mobile/desktop splits (jobs pattern)', () => {
  ...
  it('detail page uses PageHeader instead of a raw h1', () => {
