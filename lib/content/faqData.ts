...
export const FAQ_DATA: Record<FaqCategoryKey, FaqItem[]> = {
  ...
  'Cost & Funding': [
    ...
    { q: "How does WorkforceAP make money?", a: "We do not charge members. Our funding comes from three sources: (1) employer partners who pay contingent placement fees when they hire our graduates, (2) government workforce grants such as WIOA, and (3) community partnerships and donations. We only succeed when our members get jobs.", link: { text: 'Partner With Us', href: '/partners' } },
