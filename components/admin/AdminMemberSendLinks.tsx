...
type SendKind = 'interview' | 'eligibility';

type FeedbackState = { kind: SendKind; ok: boolean; message: string } | null;

/**
 * Two one-click admin actions on the member-detail page:
 ...
 *
 * Both hit admin-only POST routes and give clear sent / error feedback.
 */
