...
export const PROGRAM_COMPARISON_TRACKS: ComparisonTrack[] = [
  ...
  },
  {
    ...
    bestFor: 'Business analysis, consulting, strategy, financial analysis, and evidence-based recommendations.',
    roles: ['Management Analyst', 'Business Intelligence Analyst', 'Market Research Analyst'],
    categoryLabel: 'Cloud & Data',
    categoryOrder: 2,
  },
  {
    ...
    bestFor: 'SQL, Linux, ETL, database security, backup and recovery, and performance tuning.',
    roles: ['Database Administrator', 'Junior Database Administrator', 'Database Operations Specialist', 'Database Architect'],
    categoryLabel: 'Cloud & Data',
    categoryOrder: 2,
  },
  // ── AI & Software Dev ──
