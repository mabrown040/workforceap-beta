...
export type ProgramStatus = 'open' | 'waitlist' | 'coming_soon' | 'closed';
...
export interface Program {
  ...
  /**
   * Pre-launch status tag: open (apply now), waitlist, coming_soon, or closed.
   */
  status?: ProgramStatus;
  /**
   * Estimated month for coming_soon programs (e.g. "July 2026").
   */
...
export const PROGRAMS: Program[] = [
  ...
  mkProgram('Project Management Professional Certificate (Microsoft)', 'business', 'Business', '#a47f38', '💼', '3-5 months, 10 hrs/week', 'Starting salary: $82K-$112K', ['Agile', 'Scrum', 'MS Project', 'Risk management'], ['Project Management Foundations', 'Initiating and Planning Projects', 'Project Scheduling and Cost Management', 'Managing Project Risks, Changes and Stakeholders', 'Project Leadership, Communication and Stakeholder Management', 'Agile Project Management', 'Microsoft Project & Power BI for Project Managers', 'Project Management Capstone'], 'Microsoft', 10, undefined, 'WIOA', { es: 'full', pt: 'ai-subtitles', fr: 'ai-subtitles' }, 'open'),
  mkProgram('Data Analytics Professional Certificate (Google)', 'cloud-data', 'Cloud & Data', '#a47f38', '📊', '3-5 months, 10 hrs/week', 'Starting salary: $72K-$102K', ['Spreadsheets', 'SQL', 'R', 'Tableau', 'Data viz'], ['Foundations: Data, Data, Everywhere', 'Ask Questions to Make Data-Driven Decisions', 'Prepare Data for Exploration', 'Process Data from Dirty to Clean', 'Analyze Data to Answer Questions', 'Share Data Through the Art of Visualization', 'Data Analysis with R Programming', 'Google Data Analytics Capstone'], 'Google', 10, undefined, 'WIOA', { es: 'full', pt: 'ai-subtitles', fr: 'ai-subtitles' }, 'open'),
  ...
  mkProgram('AWS Cloud Technology Certificate', 'cloud-data', 'Cloud & Data', '#2b7bb9', '☁️', '3-5 months, 10 hrs/week', 'Starting salary: $95K-$145K', ['AWS', 'Cloud architecture', 'DevOps', 'Python'], ['Introduction to Information Technology and AWS Cloud', 'Providing Technical Support for AWS Workloads', 'Developing Applications in Python on AWS', 'Skills for Working as an AWS Cloud Consultant', 'DevOps on AWS and Project Management', 'Automation in the AWS Cloud', 'Data Analytics and Databases on AWS', 'Capstone: Following the AWS Well Architected Framework'], 'Amazon Web Services', 10, 'aws-cloud-technology-amazon', 'WIOA', { es: 'ai-subtitles', pt: 'ai-subtitles', fr: 'ai-subtitles' }, 'open'),
  mkProgram('Medical Billing and Coding Professional Certificate', 'healthcare', 'Healthcare', '#4a9b4f', '🩺', '4-6 months, 10 hrs/week', 'Starting salary: $45K-$62K', ['Medical billing', 'Medical coding', 'Medical terminology', 'Revenue cycle', 'Patient records'], ['Medical Terminology, Anatomy, and Physiology Fundamentals', 'Medical Billing and Coding Essentials', 'Medical Billing: Code and Claim Cleanly', 'Medical Billing: Code, Claim, Collect', 'Medical Coding for Max Reimbursement', 'The Billing and Collection Process', 'Reconciliation, Billing, and Collections Optimization', 'Revenue Cycle, Billing, and Coding', 'Register Patients & Validate Data', 'Introduction to Certified Professional Biller', 'Medical Records: Protect Patient Privacy', 'Medical Administrative Assistants and Office Procedures', 'Health Information Technology Fundamentals', 'Foundations of Telehealth'], 'Coursera', 14, 'medical-billing-and-coding-certificate', 'WIOA', { es: 'ai-subtitles', pt: 'ai-subtitles', fr: 'ai-subtitles' }, 'coming_soon', 'August 2026'),
