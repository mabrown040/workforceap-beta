...
export const CRON_REGISTRY: CronDef[] = [
  ...
  },
  {
    ...
    description: 'Re-engagement email to enrolled members with no portal activity in 14+ days.',
    schedule: '0 10 * * 3',
    ...
    category: 'member',
    audienceDescription: 'Enrolled members inactive 14+ days (cap 100)',
  ...
  },
  {
    ...
    description: 'Celebration email to members who completed their skills assessment in the last 24 hours.',
    schedule: '0 11 * * *',
    ...
    icon: 'emoji_events',
    category: 'member',
    audienceDescription: 'Members who completed assessment yesterday',
