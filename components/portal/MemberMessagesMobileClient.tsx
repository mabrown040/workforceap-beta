...
function PortalBottomNav() {
  ...
  return (
    <nav
      className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 md:hidden"
      style={{
        height: '5rem',
...
export default function MemberMessagesMobileClient({ initial }: { initial: InitialPayload }) {
  ...
  if (view === 'list') {
    ...
    return (
      <div className="md:hidden flex flex-col min-h-screen" style={{ background: '#fcf9f8' }}>
        {/* Header */}
        <header
