...
export const PROGRAMS: Program[] = [
  ...
  mkProgram('User Experience & Interface Design Professional Certificate', 'business', 'Business', '#a47f38', '💼', '3-5 months, 10 hrs/week', 'Starting salary: $88K-$120K', ['User research', 'Wireframing', 'Figma', 'Prototyping'], ['Foundations of User Experience (UX) Design', 'Start the UX Design Process: Empathize, Define, and Ideate', 'Build Wireframes and Low-Fidelity Prototypes', 'Conduct UX Research and Test Early Concepts', 'Create High-Fidelity Designs and Prototypes in Figma', 'Responsive Web Design in Adobe XD', 'Design a User Experience for Social Good & Prepare for Jobs'], 'Google', 10, 'ux-design-professional-certificate-google', 'WIOA', { es: 'full', pt: 'ai-subtitles', fr: 'ai-subtitles' }),
  mkProgram(
