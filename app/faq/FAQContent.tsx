...
import { ClipboardList, GraduationCap, Briefcase, DollarSign, Monitor } from 'lucide-react';
...
const categories = [
  ...
  { key: 'Schedule & Commitment', Icon: Monitor },
];
    ...
    <section className="content-section">
      <div className="container">
        ...
        {categories.map((cat) => {
          ...
          >
            <h2 style={{ fontSize: '1.3rem', fontWeight: 700, color: '#ad2c4d', marginBottom: '1.5rem', paddingBottom: '.75rem', borderBottom: '2px solid #f0f0f0', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
