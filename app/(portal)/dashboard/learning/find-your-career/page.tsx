...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Use the O*NET Interest Profiler or skill mapping tools to explore careers with more confidence.",
...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Explore occupation skills, competency charts, and gaps for a target role.",
  ...
  return (
    <>
      ...
      >
        <PageHeader
          title="Find Your Career"
          subtitle="Not sure where to start? Choose the path that matches where you are right now."
          breadcrumbs={[
        ...
        >
          ...
          >
            The <strong>Interest Profiler</strong> helps you discover the kinds
            of work that may fit you. <strong>Skill Mapping</strong> shows what
            a specific occupation requires. Both connect back to WorkforceAP
            training programs.
          </p>
        </div>
            ...
            {[
              {
                ...
                icon: "school",
                label: "Learning Hub",
                desc: "All pathways and courses",
              },
              {
                href: "/dashboard/ai-tools",
                icon: "auto_awesome",
                label: "Career Toolkit",
                desc: "Resume, interview prep, and more",
              },
              {
                href: "/dashboard/training",
                icon: "trending_up",
                label: "Training",
                desc: "Your enrolled program progress",
              },
            ].map((link) => (
              <Link
                key={link.href}
        ...
        >
          O*NET Interest Profiler™ is a trademark of the U.S. Department of
