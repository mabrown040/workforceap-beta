...
export const PROGRAM_RESOURCES: Record<string, ProgramResource[]> = {
  ...
  'digital-literacy': [
    { title: 'DigitalLearn.org (your course lessons)', description: 'Free, self-paced course pages and materials with an English/Español control; provider sign-in is optional', url: 'https://www.digitallearn.org/courses' },
