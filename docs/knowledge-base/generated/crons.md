...
| `41 14 * * *` | /api/cron/placement-survey | [route](../../../app/api/cron/placement-survey/route.ts) | platform/default or computed |
...
| `19 22 * * 5` | /api/cron/weekly-recap-email | [route](../../../app/api/cron/weekly-recap-email/route.ts) | platform/default or computed |
| `31 14 1 * *` | /api/cron/wioa-report | [route](../../../app/api/cron/wioa-report/route.ts) | platform/default or computed |
