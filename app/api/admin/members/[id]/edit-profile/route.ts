...
const schema = z.object({
  ...
  try {
    ...
    try {
      ...
      void auditLog({ actorUserId: admin.id, action: 'admin_member_profile_update', targetType: 'user', targetId: id, metadata: { fullName, phone, profilePhone, profileAddress } }).catch(() => {});
