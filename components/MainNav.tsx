    ...
    <nav className={`main-nav${scrolled ? ' scrolled' : ''}`} aria-label="Main navigation">
      <div className="nav-container" ref={navContainerRef}>
        <LocalizedLink href="/" className="logo" aria-label="Workforce Advancement Project home" onClick={closeMobile}>
          <Image src="/images/logo-tight.svg" alt="Workforce Advancement Project" width={640} height={240} className="nav-logo-image" sizes="(max-width: 900px) 130px, 210px" priority />
        </LocalizedLink>
