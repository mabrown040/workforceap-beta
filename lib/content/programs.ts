...
const DISPLAY_TITLE_OVERRIDES: Record<string, string> = {
  'it-support-professional-certificate-ibm': 'IT Support Professional Certificate',
  'it-support-and-entry-level-cyber-security-certificate': 'Entry-level Cybersecurity',
  'ai-professional-developer-certificate-ibm': 'AI and Software Developer',
  'aws-cloud-technology-amazon': 'AWS Cloud Technology',
  'medical-billing-and-coding-certificate': 'Medical Billing and Coding',
  'comptia-a-professional-certificate': 'CompTIA A+',
  'digital-marketing-e-commerce-google': 'Digital Marketing & E-Commerce',
};
...
export function getProgramDisplayTitle(program: Program | string): string {
  const slug = typeof program === 'string' ? program : program.slug;
  const override = DISPLAY_TITLE_OVERRIDES[slug];
...
export const PROGRAMS: Program[] = [
  ...
  mkProgram('IT Support Professional Certificate', 'it-cyber', 'IT & Cybersecurity', '#ad2c4d', '💻', '3-5 months, 10 hrs/week', 'Starting salary: $55K-$72K', ['Help desk', 'Hardware', 'Software', 'Customer service'], ['Introduction to Technical Support', 'Introduction to Hardware and Operating Systems', 'Introduction to Software, Programming, and Databases', 'Introduction to Networking and Storage', 'Introduction to Cybersecurity Essentials', 'Introduction to Cloud Computing', 'Technical Support Case Studies and Capstone Project'], 'IBM', 10, 'it-support-professional-certificate-ibm', 'WIOA', { es: 'ai-subtitles', pt: 'full', fr: 'ai-subtitles' }),
  mkProgram('Entry-level Cybersecurity', 'it-cyber-entry', 'IT & Cybersecurity', '#ad2c4d', '🛡️', '3-5 months, 10 hrs/week', 'Starting salary: $60K-$88K', ['Help desk', 'Networking', 'Security fundamentals', 'Incident response'], ['IT Support Foundations', 'Computer Hardware and Operating Systems', 'Networking Fundamentals', 'Cybersecurity Essentials', 'Entry-Level Security Operations', 'Career Preparation for IT and Cybersecurity'], 'IBM / CompTIA', 10, 'it-support-and-entry-level-cyber-security-certificate', 'WIOA', { es: 'ai-subtitles', pt: 'ai-subtitles', fr: 'ai-subtitles' }),
  mkProgram('AI and Software Developer', 'ai-software', 'AI & Software Dev', '#8b4a9b', '🤖', '3-5 months, 10 hrs/week', 'Starting salary: $85K-$135K', ['AI/ML', 'Generative AI', 'AI ethics', 'NLP'], ['Introduction to Artificial Intelligence (AI)', 'Artificial Intelligence: An Overview', 'Introduction to Digital Transformation Part 1', 'AI For All', 'AI Concepts and Strategy', 'Generative AI for Everyone', 'Machine Learning for All', 'AI Ethics and Governance', 'Natural Language Processing', 'Computer Vision Fundamentals', 'AI for Healthcare', 'AI Product Management', 'Reinforcement Learning', 'AI Capstone Project', 'AI Practitioner Cert Prep', 'Emerging AI Technologies'], 'Coursera partners', 10, 'ai-professional-developer-certificate-ibm', 'WIOA', { es: 'ai-subtitles', pt: 'full', fr: 'none' }),
...
const PROGRAM_SLUG_ALIASES: Readonly<Record<string, string>> = {
  ...
  // Pre-2026-07 display titles (renamed to match the TWC/EdVera + Coursera
