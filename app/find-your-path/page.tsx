...
export const metadata: Metadata = buildPageMetadata({
  title: 'Find Your Path â€” Career Quiz',
  description:
    ...
    <div className="inner-page">
      <section className="page-hero find-your-path-hero">
        <div className="page-hero-content">
          ...
          <p>
            Five questions, three ranked matches, plain-English why â€” tied to the same salary bands and program pages you will see
