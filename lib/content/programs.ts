...
export const PROGRAMS: Program[] = [
  ...
  mkProgram(
    ...
    '🏭',
    '3-5 months, 10 hrs/week',
    'Starting salary: $48K-$70K',
    ['CNC', 'Manufacturing processes', 'Quality control'],
    [
      ...
      'Production Technology Capstone',
    ],
    'CPT',
    10,
  ...
  mkProgram(
    ...
    '🏭',
    '3-5 months, 10 hrs/week',
    'Starting salary: $55K-$78K',
    ['Supply chain', 'Inventory', 'Transportation', 'SAP'],
    [
      ...
      'Supply Chain Technology and SAP',
      'Global Supply Chain and Trade',
      'CLT Certification Preparation',
    ],
    'CLT',
    10,
