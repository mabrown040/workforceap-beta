...
export default async function SkillsAssessmentPage() {
  ...
  const parsedSnapshots: SavedSkillSnapshot[] = savedSnapshots.flatMap(
    (row) => {
      try {
        ...
        return [
          {
            ...
            radarAxes: Array.isArray(data.radarAxes)
              ? data.radarAxes.slice(0, 6)
              : [],
            topSkills: Array.isArray(data.skills)
      ...
      >
        <div style={{ marginTop: "1rem", marginBottom: "1.75rem" }}>
          <PageHeader
            ...
            subtitle="After you choose a program, this short assessment helps personalize your training path and career support."
            breadcrumbs={[
            ...
            {assessmentGated ? (
              ...
              >
                ...
                <div>
                  ...
                  >
                    Skills assessment opens after your intake interview
                  </h2>
                  <p
                    style={{
                      fontSize: "0.875rem",
                  ...
                  >
                    Your counselor uses the interview to confirm fit and next
                    steps. After that conversation is complete, you can take the
                    skills assessment here.
                  </p>
                  <Link
                    href="/dashboard"
                ...
                >
                  {dbUser.assessmentScorePct != null && (
                    <div>
                      ...
                      {dbUser.assessmentScore != null && (
                        ...
                        >
                          {dbUser.assessmentScore}/{TOTAL_POINTS} points
                        </p>
                      )}
                    </div>
                  )}
                  ...
                  {dbUser.enrolledProgram && (
                    <div>
                      ...
                      >
                        {getProgramBySlug(dbUser.enrolledProgram)?.title ??
                          dbUser.enrolledProgram}
                      </p>
                    </div>
                  )}
              ...
              >
                ...
                <div>
                  ...
                  >
                    This 10-minute assessment helps personalize your learning
                    plan and unlock your first training steps.
                  </p>
                  <Link
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    Saved{" "}
                    {new Date(latestSnapshot.savedAt).toLocaleDateString(
                      undefined,
              ...
              {certs.slice(0, 5).map((cert) => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    >
                      Earned{" "}
                      {cert.earnedAt.toLocaleDateString(undefined, {
                        month: "long",
                        day: "numeric",
                        year: "numeric",
                      })}
              ...
              {[
                {
                  icon: "radar",
                  title: "Skill Mapper",
                  desc: "Map your skills to any O*NET occupation.",
                  href: "/dashboard/ai-tools/skill-mapper",
                },
                {
                  icon: "description",
                  title: "Resume Rewriter",
                  desc: "Turn your skills into a polished resume.",
                  href: "/dashboard/ai-tools/resume-rewriter",
                },
                {
                  icon: "mic",
                  title: "Interview Coach",
                  desc: "Practice answering skill-based questions.",
                  href: "/dashboard/ai-tools/interview-coach",
                },
                {
                  icon: "query_stats",
                  title: "Job Match Scorer",
                  desc: "See how your skills match a job posting.",
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <p className="portal-quick-action-item__label">
                      {tool.title}
                    </p>
                    <p className="portal-quick-action-item__desc">
                      {tool.desc}
                    </p>
                  </div>
                  <span
        ...
        >
          ...
          >
            Your answers help counselors personalize your learning path,
            recommend certifications, and connect you with job placement
