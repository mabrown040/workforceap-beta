...
const patchSchema = z.object({
  ...
  try {
    ...
    void auditLog({ actorUserId: user.id, action: 'admin_partner_update', targetType: 'partner', targetId: partnerId, metadata: { ...updateData, subgroupIds: data.subgroupIds } }).catch(() => {});
