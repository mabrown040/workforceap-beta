      ...
      <div className="wa-md:wa-hidden" style={{ paddingBottom: '6rem' }}>
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.65rem' }}>
            ...
            >
              <span className="material-symbols-outlined" style={{ fontSize: '1.2rem', color: '#fff' }}>target</span>
            </div>
            <div>
        ...
        <div style={{ padding: '1rem' }}>
          ...
          >
            <p style={{ fontSize: '0.82rem', lineHeight: 1.55, color: 'var(--color-on-surface-variant)', margin: 0 }}>
              Paste a job description and your resume. Get a match score and specific keyword gaps to address
              before you apply.
            </p>
          </div>
