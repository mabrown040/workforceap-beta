...
export async function POST(request: Request) {
  ...
  try {
    ...
    return NextResponse.json(
      { error: 'Generation failed â€” check your API key or try again' },
      { status: 500 }
    );
  }
}
