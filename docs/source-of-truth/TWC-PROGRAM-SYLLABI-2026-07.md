...
The SHA-256 values below identify the exact `.docx` files supplied by the program owner. The canonical TypeScript transcription preserves every program title, provider line, delivery format, hour statement, tuition/fee statement, prerequisite, description, course order, per-course hour value, and course description used on the public website.
...
| 6 | `data-analytics-professional-certificate-google` | `6-Data_Analytics_Professional_Certificate_Google.docx` | `07c28debfbec0c9a8717ffb6f359c8df4900812915d8691c288dc813b68caf4e` |
| 7 | `data-science-professional-certificate-ibm` | `7-Data_Science_Professional_Certificate_IBM.docx` | `a291fd3af7910160d27ff00491e9380cbc41d3c4ef54eb56c21594e44c4d865c` |
...
| 9 | `ux-design-professional-certificate-google` | `9-UX_Design_Professional_Certificate_Google.docx` | `6aa6f5826e0f44a2e5c43914c1c43aac4acc7dbe4dc3b7bf30841bb9633c15b7` |
