...
| Name | Badge | Description | Example | Used In |
|------|-------|-------------|---------|---------|
| `ELEVENLABS_API_KEY` | 🟡 🔒 | API key from the WorkforceAP nonprofit workspace; runtime requires ElevenAgents read and Text to Speech access | `sk_...` | Voice UI, signed URLs |
