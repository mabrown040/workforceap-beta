# Coursera Language Availability Research
...
|---|---------|---------|---------|------------|--------|
| 1 | Data Analytics Professional Certificate | Google | ✅ Full | ⚡ AI subtitles | ⚡ AI subtitles |
| 2 | Cybersecurity Professional Certificate | Google | ✅ Full | ⚡ AI subtitles | ⚡ AI subtitles |
| 3 | Digital Marketing & E-Commerce | Google | ✅ Full | ⚡ AI subtitles | ⚡ AI subtitles |
| 4 | UX Design Professional Certificate | Google | ✅ Full | ⚡ AI subtitles | ⚡ AI subtitles |
| 5 | IT Automation with Python | Google | ✅ Full | ✅ Full | ⚡ AI subtitles |
| 6 | Project Management Professional Certificate | Microsoft | ✅ Full | ⚡ AI subtitles | ⚡ AI subtitles |
| 7 | Data Analyst Professional Certificate | IBM | 📜 Subtitles | ✅ Full | ⚡ AI subtitles |
| 8 | Data Science Professional Certificate | IBM | ⚡ AI subtitles | ✅ Full | ⚡ AI subtitles |
| 9 | Software Developer Professional Certificate | IBM | ⚡ AI subtitles | ✅ Full | ⚡ AI subtitles |
| 10 | IT Support Professional Certificate | IBM | ⚡ AI subtitles | ✅ Full | ⚡ AI subtitles |
...
### 2.2 Internal Programs (6) — No Coursera Language Layer
...
| 19 | AWS Cloud Technology | Amazon Web Services | ⚡ AI subtitles | ⚡ AI subtitles | ⚡ AI subtitles |
...
**Subtitles only (2):**
- IBM Data Analyst — human-translated subtitles
...
**Partial / patchy (1):**
- Health Information Technology — some Spanish-language materials exist but coverage is inconsistent across modules

**No support (6):**
- All internal programs (Digital Literacy, CPT, CLT, Core Construction, AWS Cloud, plus Health Information Technology for non-patchy content)
...
### 4.1 Surface Language Availability Before Enrollment
...
4. **Curriculum localization** — For Health Information Technology, which has patchy Spanish support, invest in completing the translation or creating a Spanish-first companion module

### 4.4 Member Preference Capture
...
## 5. Next Steps for WorkforceAP

| Priority | Action | Owner | Timeline |
|----------|--------|-------|----------|
| P0 | Add language support metadata to `lib/content/programs.ts` (new field: `languagesSupported`) | Engineering | This sprint |
...
## 6. Appendix: Full Program List

For reference, all 19 programs in canonical order:

1. Digital Literacy Empowerment Class
2. IT Support Professional Certificate (IBM)
3. AI Professional Practitioner Certificate (IBM)
