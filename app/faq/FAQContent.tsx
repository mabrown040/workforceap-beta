...
const faqData: Record<string, { q: string; a: string }[]> = {
  ...
  'Job Placement Assistance': [
    ...
    { q: 'Who are your employer partners?', a: 'We partner with 200+ employers across tech, healthcare, finance, and government. Partners include Google Cloud, Amazon Web Services, Microsoft, Dell Technologies, IBM, EY, and local Austin companies like HomeAway, RetailMeNot, and Oracle Austin. Many actively recruit from our graduation cohorts.' },
