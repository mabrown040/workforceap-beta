    ...
    <div className="apply-flow">
      ...
      {step === 1 && (
        <div className="apply-step-content">
          ...
          <p style={{ marginTop: '1.5rem', fontSize: '.85rem', color: 'var(--color-gray-600)', textAlign: 'center' }}>
            Having trouble? Call{' '}
      ...
      {step === 2 && (
        <div className="apply-step-content">
          <h2 className="apply-step-title">Complete your application</h2>
          <p className="apply-step-desc">Fill out the form below and a counselor will contact you within 24–48 hours.</p>
