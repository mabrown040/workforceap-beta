...
describe('formatTrustStripLine', () => {
  ...
  it('formats live placement, partner, and wage stats', () => {
    const metrics: TrustStripMetrics = {
      membersPlaced: 912,
      partnerCompanies: 43,
    ...
    expect(formatTrustStripLine(metrics)).toBe(
      '912 members placed · 43 partner companies · $48.5K avg starting wage',
    );
  });
