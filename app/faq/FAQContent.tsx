...
const faqData: Record<string, { q: string; a: string; link?: { text: string; href: string } }[]> = {
  ...
  'Cost & Funding': [
    ...
    { q: "What does 'qualifying' mean?", a: "16+, US citizen or permanent resident, unemployed or underemployed, household income under $60K â€” you likely qualify. We also consider special circumstances. Apply and we'll confirm within 24â€“48 hours. Currently serving the Austin area; we're expanding.", link: { text: 'Check Your Eligibility', href: '/apply' } },
  ...
  'Programs & Training': [
    { q: 'How long are the programs?', a: 'Most programs take 3â€“5 months at 10 hours per week. Digital Literacy is shorter at 6â€“7 weeks. All programs are designed to be completed while working part-time or managing family responsibilities.', link: { text: 'View Program Details', href: '/programs' } },
    { q: 'Are programs online or in person?', a: 'Virtual and hybrid â€” you can complete training from home with an internet connection. Some programs offer optional in-person events and career fairs. Currently concentrated in the Austin area; format may vary as we expand.', link: { text: 'See Available Programs', href: '/programs' } },
    ...
    { q: 'Can I use a tablet or phone instead of a computer?', a: 'No. Programs require a laptop or desktop computer with a keyboard for coursework, labs, and certification exams. Tablets and phones are not sufficient. If you don\'t have access to a computer, ask about our Loaner Laptop Program during intake â€” we may be able to help.', link: { text: 'View Programs', href: '/programs' } },
    { q: 'What certifications will I earn?', a: "You'll earn industry-recognized certificates from partners like Google, IBM, Microsoft, Amazon, and CompTIA. These are the same credentials employers hire against â€” not generic 'certificates of completion.'", link: { text: 'View Certification Paths', href: '/salary-guide' } },
  ...
  'Job Placement': [
    ...
    { q: 'What kind of jobs will I qualify for?', a: 'Entry-level to mid-level roles in IT, cybersecurity, data analytics, project management, healthcare, and skilled trades. Starting salaries range from $38K to $145K depending on the program. Many graduates see significant salary increases within 2â€“3 years.', link: { text: 'See Salary Guide', href: '/salary-guide' } },
    { q: 'How soon after graduating can I get hired?', a: 'Many members begin applying during training. Job placement timelines vary, but our team works with you from day one of training through your first hire. Most graduates secure employment within 3â€“6 months of certification.', link: { text: 'Read Career Tips', href: '/blog' } },
  ...
  'Schedule & Commitment': [
    ...
    { q: 'What if I fall behind?', a: "Your counselor will work with you to adjust your pace. We're invested in your completion â€” not just your enrollment. Life happens, and we'll help you get back on track if you need to pause or slow down.", link: { text: 'Meet the Team', href: '/leadership' } },
  ],
  'Support & Resources': [
    ...
    { q: 'Can I get a loaner laptop if I don\'t have a computer?', a: 'Loaner laptops are typically awarded upon successful program completion. If you lack computer access and it would prevent you from participating, discuss this during your intake call â€” we may have limited options to support you earlier.', link: { text: 'Learn About Support', href: '/what-we-do' } },
    { q: 'How do partner referrals work?', a: 'Community partners, employers, and service providers can refer individuals to WorkforceAP. If you were referred, you follow the same application process â€” we reach out within 24â€“48 hours. Referrals don\'t guarantee acceptance, but we prioritize timely follow-up.', link: { text: 'Learn About Partners', href: '/partners' } },
  ],
  'Common Concerns': [
    { q: 'Is this too good to be true?', a: 'We get it â€” free training with job placement sounds skeptical. Here\'s the deal: we\'re funded by grants, employer partnerships, and community support. Our success metric is your employment, not your tuition. We don\'t profit from your enrollment; we profit when you land a job. Check our leadership page â€” these are real people with decades of workforce experience.', link: { text: 'Meet the Team', href: '/leadership' } },
    { q: 'How do you make money if training is free?', a: 'We\'re a nonprofit. Funding comes from grants, employer partnerships (they pay for talent pipeline access), and community funders. We don\'t charge participants. Our revenue is from organizations that want trained, certified workers â€” not from you.', link: { text: 'See How It Works', href: '/how-it-works' } },
    { q: 'I\'ve been burned by programs before. Why should I trust this?', a: 'Fair concern. We\'re transparent: no loans, no ISAs, no hidden costs. You can walk away anytime. Our leadership has 25+ years in workforce development â€” Goodwill, Urban League, consulting. This isn\'t a fly-by-night operation. Talk to us before you commit: (512) 777-1808.', link: { text: 'Meet the Team', href: '/leadership' } },
    { q: 'What if I\'m not tech-savvy?', a: 'Many of our best graduates started with zero tech experience. We have programs from Digital Literacy (basics) to advanced certifications. The pathfinder quiz helps match you to the right level. Don\'t self-select out â€” let us help you find the fit.', link: { text: 'Take the Pathfinder Quiz', href: '/find-your-path' } },
  ],
  'For Families & Partners': [
    { q: 'My family member is considering this. What should I know?', a: 'WorkforceAP provides no-cost career training with job placement support. No loans, no debt, no income-sharing agreements. Programs run 6 weeks to 6 months, mostly online. We assign a counselor and provide resources like resume help and interview prep. You\'re welcome to join an info call with them â€” we encourage family support.', link: { text: 'See How It Works', href: '/how-it-works' } },
    { q: 'As a partner, how do I know this is legitimate?', a: 'We\'re a registered nonprofit with real leadership â€” Michael Brown (PMP) has trained thousands through Goodwill, Austin Area Urban League, and other established organizations. We work with employers who hire our graduates. Refer your clients with confidence; we follow up within 24â€“48 hours and don\'t charge referrals.', link: { text: 'Partner With Us', href: '/partners' } },
    { q: 'Can I refer someone who lives outside Austin?', a: 'We\'re currently serving the Austin area as our launch community. We\'re building toward expansion. You can still refer â€” we\'ll intake, assess, and keep them in the loop for when we expand. No harm in applying.', link: { text: 'Refer Someone', href: '/partners' } },
  ],
};
    ...
    <section className="content-section">
      <div className="container">
        ...
        <div style={{ background: 'linear-gradient(135deg,#1a1a1a,#2d2d2d)', color: 'white', borderRadius: '12px', padding: '3rem', textAlign: 'center', marginTop: '4rem' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,.8)', marginBottom: '1.5rem' }}>Our team responds within 24â€“48 hours â€” reach out any time.</p>
