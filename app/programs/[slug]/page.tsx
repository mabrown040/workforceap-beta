        ...
        <div className="container program-detail-grid">
          <div className="program-detail-main">
            ...
            <div className="program-bottom-cta" style={{ 
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '0.75rem', color: 'var(--color-primary)' }}>
                Ready to start your career in {program.categoryLabel}?
              </h3>
              <p style={{ fontSize: '1rem', color: 'var(--color-gray-600)', marginBottom: '1.5rem', maxWidth: '500px', margin: '0 auto 1.5rem' }}>
