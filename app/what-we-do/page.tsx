...
import { Crosshair, Globe, Lightbulb, Handshake, TrendingUp } from 'lucide-react';
        ...
        <div className="container">
          <div className="mission-vision-grid">
            <div className="mv-card animate-on-scroll">
              <div className="mv-icon mission"><Crosshair size={32} className="text-current" /></div>
              <h2>Mission</h2>
          ...
          <div className="values-grid">
            {[
              { Icon: Crosshair, name: 'Equity', desc: 'Ensuring fair access to opportunity, training, and economic mobility for all individuals.' },
