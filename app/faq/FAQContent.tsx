...
const faqData: Record<string, { q: string; a: string; link?: { text: string; href: string } }[]> = {
  'General Questions': [
    ...
    { q: 'How long do programs take?', a: 'Current website program pacing is standardized to about 6 weeks at roughly 5 hours per week, or about 30 total hours. Everything is designed so you can participate while working, parenting, or managing other commitments.', link: { text: 'View Programs', href: '/programs' } },
  ...
  'Programs & Training': [
    { q: 'How long do programs take?', a: 'Current website program pacing is standardized to about 6 weeks at roughly 5 hours per week, or about 30 total hours. All programs are designed to be completed while working part-time or managing family responsibilities.', link: { text: 'View Program Details', href: '/programs' } },
  ...
  'For Members': [
    ...
    { q: 'Can I work while enrolled?', a: 'Yes. Programs are designed to be flexible for working adults. The current website pacing of about 5 hours per week is manageable alongside most work schedules.', link: { text: 'Check Program Flexibility', href: '/programs' } },
