...
const faqData: Record<string, { q: string; a: string }[]> = {
  ...
  Programs: [
    ...
    { q: 'Are classes online or in-person?', a: 'Both! Most training is available online for flexibility. We also offer in-person programs in the Austin area. When you apply, indicate your preference and we will match you with the format that works best for your situation.' },
  ...
  'Support & Scheduling': [
    ...
    { q: 'Can you help me choose the right schedule?', a: 'Yes. We offer multiple program timelines, and our team can help you compare pacing, expected weekly hours, and the next available start dates during your intake call.' },
    { q: 'What if I need to take a break?', a: "Life happens! You can pause your current program and join a future one (within 12 months), adjust to a part-time schedule, or work with instructors on an extension timeline. We want you to succeed, so we're willing to work with you on solutions that fit your circumstances." },
  ...
  Technical: [
    { q: 'What if I have technical difficulties during the program?', a: 'Our IT Support Team is available during all live sessions and office hours. Contact us via chat during sessions, email support@workforceap.org, or schedule a 1-on-1 tech support appointment. Most issues are resolved within 24–48 hours.' },
