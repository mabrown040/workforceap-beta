...
| /api/member/messages | route | GET, POST, PATCH | [app/api/member/messages/route.ts](../../../app/api/member/messages/route.ts) | @/lib/auth/server:2, @/lib/messages/rateLimit:10, @/lib/db/withRequestGuc:14 |
