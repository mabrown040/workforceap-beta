...
- ElevenLabs/provider-side privacy: no voice recording, zero-day retention, transcript/PII and audio deletion, zero-retention mode; existing conversations are not retroactively mutated. These settings govern provider retention only.
