...
| [tests/api/admin-user-lifecycle.spec.ts](../../../tests/api/admin-user-lifecycle.spec.ts) | 273 | tests |  |
| [tests/api/admin-user-patch-route.spec.ts](../../../tests/api/admin-user-patch-route.spec.ts) | 208 | tests |  |
| [tests/api/admin-user-reset-password.spec.ts](../../../tests/api/admin-user-reset-password.spec.ts) | 110 | tests |  |
