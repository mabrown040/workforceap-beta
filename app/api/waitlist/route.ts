...
export async function POST(request: NextRequest) {
  try {
    ...
    // Also create a notification for admin visibility
    await createNotification({
      userId: 'system', // system notification for admin visibility
      type: 'broadcast',
      title: `Waitlist signup: ${programSlug}`,
      body: `${email} joined the waitlist for ${programSlug}.`,
    });
